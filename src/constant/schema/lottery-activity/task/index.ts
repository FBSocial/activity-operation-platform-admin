 ...
 * @property {Object} LikeCircleXTimes - 完成动态互动任务（点赞、评论、转发）
...
const AllTasks = {
    ...
    CumulativeCheckInDays: { name: '累计签到%天', value: 3, desc: '累计签到的类型配置', key: 'CumulativeCheckInDays', channel: 'integral', task_event: 'task_integral_sign_in', type: 'ActivateAndRetain' },
    /** @property {Object} CumulativeLoginDays - 累计登录活动%天 */
    CumulativeLoginDays: { name: '累计登录活动%天', value: 4, desc: '用户在活动期间内累计登录活动页面指定天数', key: 'CumulativeLoginDays', channel: 'fb', task_event: 'task_fb_actvity_login', type: 'ActivateAndRetain' },
    ...
    PostXDynamicInTopic: { name: '到指定的圈子话题下发帖', value: 8, desc: '用户在指定话题下发布指定数量的动态', key: 'PostXDynamicInTopic', channel: 'fb', task_event: 'task_fb_circle_post', type: 'ActivateAndRetain' },
    /** @property {Object} LikeCircleXTimes - 完成任意动态的点赞、评论、转发行为 */
    LikeCircleXTimes: { name: '完成任意动态的点赞、评论、转发行为', value: 9, desc: '用户在活动期间内点赞圈子指定次数', key: 'LikeCircleXTimes', channel: 'fb', task_event: 'task_fb_circle_interaction', type: 'ActivateAndRetain' },
    /** @property {Object} CompleteXComments - 完成任意动态的点赞、评论、转发行为 */
    CompleteXComments: { name: '完成任意动态的点赞、评论、转发行为', value: 9, desc: '用户在活动期间内完成指定次数的评论', key: 'CompleteXComments', channel: 'fb', task_event: 'task_fb_circle_interaction', type: 'ActivateAndRetain' },
    ...
    /** @property {Object} CompleteXAnswers - 完成问答回答 */
    CompleteXAnswers: { name: '完成问答回答 ', value: 11, desc: '用户在活动期间内完成指定次数的回答', key: 'CompleteXAnswers', channel: 'fb', task_event: 'task_fb_question_answer', type: 'ActivateAndRetain' },
    ...
    DailyShareActivity: { name: '每日分享活动', value: 1, desc: '用户每天分享活动页面', key: 'DailyShareActivity', channel: 'fb', task_event: 'task_fb_actvity_share', type: 'ShareAndAcquire' },
